...
- (void)stateMeta
{
 ...
 ///////
     ...
     */
    CGSize cardNumberSize = [self.cardNumber.formattedString sizeWithAttributes: @{NSFontAttributeName:
                            [UIFont boldSystemFontOfSize:17]}];
    CGSize lastGroupSize = [self.cardNumber.lastGroup sizeWithAttributes: @{NSFontAttributeName:
                                                                                       [UIFont boldSystemFontOfSize:17]}];
